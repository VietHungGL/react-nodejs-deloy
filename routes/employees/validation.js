...
const employeesPutSchema = yup.object({
  body: yup.object({
...
const employeesPatchSchema = yup.object({
  body: yup.object({
    firstName: yup.string().max(50, "Họ được vượt quá 50 ký tự"),

    lastName: yup.string().max(50, "Tên được vượt quá 50 ký tự"),
